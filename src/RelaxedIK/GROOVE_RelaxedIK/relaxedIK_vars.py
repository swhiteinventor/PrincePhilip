...
# additional objectives: Position_MultiEE_Obj() (weight func = Identity_Weight(), weight_prior = 50.0), Orientation_MultiEE_Obj() (weight func = Identity_Weight(), weight_prior = 40.0)
class RelaxedIK_vars(Vars):
    def __init__(self, name,
                 ...
                 objectives=(Position_Obj(), Orientation_Obj(), Arm0_Look_At_Obj(), Arm0_High(), Roll_Limit(), Min_Jt_Vel_Obj(),Min_Jt_Accel_Obj(),Min_Jt_Jerk_Obj(), Joint_Limit_Obj(), Collision_Avoidance_nn()),
                 ...
                 weight_priors=(50.0, 40.0, 50.0, 15.0, 50.0, 0.3,0.3,0.3,1.0,2.0),
                 constraints=(),
                 bounds=(),
                 collision_file='',
